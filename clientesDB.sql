...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2024 a las 20:02:53
...
--
CREATE DATABASE IF NOT EXISTS `clientesdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `clientesdb`;
...
INSERT INTO `clientes` (`id`, `dni`, `nombre`, `direccion`, `localidad`, `provincia`, `telefono`, `email`) VALUES
(2, '234234234', 'Anita', 'wdfsfs', 'sdfsd', 'fsdfsdf', 'sdfsdf', 'sdfsdf'),
(3, 'sfsdf', 'sdfsd', 'fsdfsdf', 'sdfs', 'sdf', 'dfsdfsd', 'sdfsdf'),
(4, 'Pablo', '23232323F', 'C/ Ejemplo', 'Pego', 'Alicante', '654654654', 'pablo@gmail.com');
...
('root', '[{\"db\":\"clientesdb\",\"table\":\"clientes\"}]');
...
('root', '2024-12-03 19:00:51', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
